document.addEventListener('DOMContentLoaded',()=>{
 ...
 document.querySelectorAll('.site-links a').forEach(a=>a.addEventListener('click',()=>{if(header)header.classList.remove('open');if(btn){btn.setAttribute('aria-expanded','false');btn.textContent='☰'}}));
